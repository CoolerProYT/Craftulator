...
import { data } from '../craftulator'
import ItemSlot from './ItemSlot.vue'

const props = defineProps<{ id: string }>()

const recipe = computed(() => data.recipes.find((r) => r.id === props.id || r.id === `craftulator:${props.id}`))
...
<template>
  <div v-if="recipe" class="cc-recipe">
    <div class="grid">
  ...
  <p v-else class="cc-muted">Recipe {{ id }} not found.</p>
</template>
